...
def to_buy_hold_sell_MA(data,days='15'):
    ...
    rolling_close = data['rollingClose'+days][-3:] # take last 3 days
...
def model_growth(data,model):
    ...
    shares = 1
    for day,i in enumerate(range(-from_days_back,-to_days_back)):
        d = data[:i]
        what_to_do = model(d)
        if what_to_do == 'buy':
            price = d['Close'][-1]
...
net_worth_MA3 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='3'))
net_worth_MA5 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='5'))
net_worth_MA10 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='10'))
net_worth_MA15 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='15'))
net_worth_MA25 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='25'))
net_worth_MA50 = model_growth(history,lambda x: to_buy_hold_sell_MA(x,days='50'))
...
net_worth_MA3['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA3['rollingClose3'] = history['rollingClose3'][-from_days_back:-to_days_back]
net_worth_MA5['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA5['rollingClose5'] = history['rollingClose5'][-from_days_back:-to_days_back]
net_worth_MA10['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA10['rollingClose10'] = history['rollingClose10'][-from_days_back:-to_days_back]
net_worth_MA15['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA15['rollingClose15'] = history['rollingClose15'][-from_days_back:-to_days_back]
net_worth_MA25['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA25['rollingClose25'] = history['rollingClose25'][-from_days_back:-to_days_back]
net_worth_MA50['Close'] = history['Close'][-from_days_back:-to_days_back]
net_worth_MA50['rollingClose50'] = history['rollingClose50'][-from_days_back:-to_days_back]
